...
@section ('content')
            ...
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    @if($withdrawRedLabel->approve_user_id == 0)
                        <a href="{{ route('whs.withdraw-red-label.edit', $withdrawRedLabel->id) }}" class="btn btn-info waves-effect">แก้ไขใบเบิกทำป้ายแดง</a>
                    @endif
                    <button type="button" class="btn btn-danger waves-effect button-delete">ยกเลิกใบเบิกทำป้ายแดง</button>
                    <button class="btn btn-warning waves-effect" type="button" onclick="location.href='{{ route('whs.withdraw-red-label.index') }}'">กลับ</button>
                </div>
    ...
    <form action="{{ route('whs.withdraw-red-label.destroy', $withdrawRedLabel->id) }}" method="post" id="formDestroy">
        @csrf
        @method('delete')
    </form>
@stop
...
@section('script')
    <script type="text/javascript">
        $('.button-delete').click(function () {
            swal({
                title: "ยืนยันยกเลิกใบเบิกทำป้ายแดง?",
                type: "warning",
