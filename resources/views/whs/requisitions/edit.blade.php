...
@section('content')
    <div class="row">
        <form method="POST" action="{{ route('whs.requisitions.update', $requisition->id) }}" class="form-horizontal" id="FormSubmit">
            @csrf
            @method('PUT')
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <a href="{{ route('whs.requisitions.index') }}" class="btn btn-warning waves-effect">ยกเลิก</a>
                </div>
